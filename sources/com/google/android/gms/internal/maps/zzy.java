...
public final class zzy extends zza implements zzw {
    ...
    public final List<LatLng> getPoints() throws RemoteException {
        ...
        ArrayList<LatLng> createTypedArrayList = transactAndReadException.createTypedArrayList(LatLng.CREATOR);
        transactAndReadException.recycle();
    ...
    public final List<PatternItem> getStrokePattern() throws RemoteException {
        ...
        ArrayList<PatternItem> createTypedArrayList = transactAndReadException.createTypedArrayList(PatternItem.CREATOR);
        transactAndReadException.recycle();
        return createTypedArrayList;
    }
