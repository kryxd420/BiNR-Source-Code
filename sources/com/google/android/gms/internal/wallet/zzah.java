...
final class zzah extends zzaf {
    ...
    public final void zza(int i, Bundle bundle) {
        ...
        AutoResolveHelper.zza((pendingIntent == null || i != 6) ? new Status(i) : new Status(i, "Need to resolve PendingIntent", pendingIntent), new AutoResolvableVoidResult(), this.zzgj);
    }
}
