...
public final class WebImage extends AbstractSafeParcelable {
    ...
    public WebImage(JSONObject jSONObject) throws IllegalArgumentException {
        this(zaa(jSONObject), jSONObject.optInt(AvidJSONUtil.KEY_WIDTH, 0), jSONObject.optInt(AvidJSONUtil.KEY_HEIGHT, 0));
    }
    ...
    public final JSONObject toJson() {
        ...
        try {
            ...
            jSONObject.put(AvidJSONUtil.KEY_WIDTH, this.zand);
            jSONObject.put(AvidJSONUtil.KEY_HEIGHT, this.zane);
        } catch (JSONException unused) {
        }
        return jSONObject;
    }
