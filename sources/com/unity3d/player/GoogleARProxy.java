...
class GoogleARProxy extends b {
    ...
    public static boolean a() {
        try {
            ...
            if (((Number) mVar.a("getClassVersion", new Object[0])).intValue() > 0) {
                Log.d(AdColonyAppOptions.UNITY, "Loading ARCore V1+ path.");
                return false;
            }
            Log.d(AdColonyAppOptions.UNITY, "Loading ARCore Preview path (Version <= 1).");
            return true;
        } catch (Exception unused) {
            Log.d(AdColonyAppOptions.UNITY, "Loading ARCore Preview path.");
            return true;
        }
    }
    ...
    private boolean a(ClassLoader classLoader) {
        ...
        try {
            ...
            mVar.a(TapdaqPlacement.TDPTagPause, new Class[0]);
            ...
            d dVar = this.b;
            dVar.reportError("Google AR Error", e.toString() + e.getLocalizedMessage());
            return false;
        }
    }
            ...
            runOnUiThread(new Runnable() {
                public final void run() {
                    try {
                        ...
                        GoogleARProxy googleARProxy = GoogleARProxy.this;
                        googleARProxy.reportError("Exception creating " + GoogleARProxy.this.e + " VR on UI Thread. " + e.getLocalizedMessage());
                    }
                }
            });
        }
    ...
    public final void c() {
        runOnUiThread(new Runnable() {
            public final void run() {
                try {
                    if (GoogleARProxy.this.a != null) {
                        GoogleARProxy.this.a.a(TapdaqPlacement.TDPTagPause, new Object[0]);
                    }
                } catch (Exception e) {
                    GoogleARProxy googleARProxy = GoogleARProxy.this;
                    googleARProxy.reportError("Exception pausing " + GoogleARProxy.this.e + " VR on UI Thread. " + e.getLocalizedMessage());
                }
            }
        });
    }
        ...
        runOnUiThread(new Runnable() {
            public final void run() {
                try {
                    ...
                    GoogleARProxy googleARProxy = GoogleARProxy.this;
                    googleARProxy.reportError("Exception resuming " + GoogleARProxy.this.e + " VR on UI Thread. " + e.getLocalizedMessage());
                }
            }
        });
    }
