...
public class SensorInfoListener implements SensorEventListener {
    ...
    public static JSONObject getAccelerometerData() {
        ...
        try {
            jSONObject.put(AvidJSONUtil.KEY_X, (double) _latestAccelerometerEvent.values[0]);
            jSONObject.put(AvidJSONUtil.KEY_Y, (double) _latestAccelerometerEvent.values[1]);
