...
public final class iu extends RelativeLayout implements View.OnClickListener {
    ...
    public iu(Context context, hy hyVar, a aVar) {
        ...
        if (this.h.m != null) {
            hz hzVar = this.h.m;
            if (hzVar.a == null || (hzVar.b == null && hzVar.c == null)) {
                z = false;
            }
            if (z) {
                this.g = new ir(context2);
        ...
        this.f.setImageBitmap(hyVar.c.b);
        if (this.g != null && hyVar.m != null && hyVar.m.a != null) {
            this.g.setImageBitmap(hyVar.m.a.b);
        }
    }
    ...
    public final void setLandscape(boolean z) {
        ...
        ae.a(this.c, new BitmapDrawable((Resources) null, bitmap));
        ae.a(this.d, new BitmapDrawable((Resources) null, bitmap2));
    ...
    public final void onMeasure(int i2, int i3) {
        ...
        int i5 = 320;
        layoutParams.width = a(this.a ? FetchService.QUERY_SINGLE : 320);
        if (!this.a) {
            i5 = FetchService.QUERY_SINGLE;
        }
        ...
        for (View view : af.a(this.e)) {
            FrameLayout.LayoutParams layoutParams4 = (FrameLayout.LayoutParams) view.getLayoutParams();
            Rect rect = ((hw) view.getTag()).a;
    ...
    public final void onClick(View view) {
        if (view == this.f) {
            ...
            irVar.invalidate();
            this.i.b();
        } else if (view.getTag() instanceof hw) {
            this.i.a((hw) view.getTag());
        }
    }
}
