...
public class Placeholder extends View {
    ...
    public void onDraw(Canvas canvas) {
        if (isInEditMode()) {
            ...
            paint.setARGB(255, TapdaqError.UNABLE_TO_DISPLAY_UNKNOWN_AD_TYPE, TapdaqError.UNABLE_TO_DISPLAY_UNKNOWN_AD_TYPE, TapdaqError.UNABLE_TO_DISPLAY_UNKNOWN_AD_TYPE);
