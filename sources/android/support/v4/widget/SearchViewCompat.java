...
public final class SearchViewCompat {
    ...
    public static void setSearchableInfo(View view, ComponentName componentName) {
        ...
        ((SearchView) view).setSearchableInfo(((SearchManager) view.getContext().getSystemService(AppLovinEventTypes.USER_EXECUTED_SEARCH)).getSearchableInfo(componentName));
    }
