...
final class SwipeProgressBar {
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.mRunning || this.mFinishTime > 0) {
            ...
            long j = (currentAnimationTimeMillis - this.mStartTime) % FetchConst.DEFAULT_ON_UPDATE_INTERVAL;
            long j2 = (currentAnimationTimeMillis - this.mStartTime) / FetchConst.DEFAULT_ON_UPDATE_INTERVAL;
