    ...
    class RelaySource implements Source {
        ...
        public long read(okio.Buffer r22, long r23) throws java.io.IOException {
            /*
                ...
                monitor-enter(r4)
            L_0x000b:
                long r5 = r1.sourcePos     // Catch:{ all -> 0x0140 }
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0140 }
                long r7 = r0.upstreamPos     // Catch:{ all -> 0x0140 }
                int r0 = (r5 > r7 ? 1 : (r5 == r7 ? 0 : -1))
                r5 = 2
                r9 = -1
                if (r0 != 0) goto L_0x0039
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0140 }
                boolean r0 = r0.complete     // Catch:{ all -> 0x0140 }
                if (r0 == 0) goto L_0x0020
                monitor-exit(r4)     // Catch:{ all -> 0x0140 }
                return r9
            L_0x0020:
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0140 }
                java.lang.Thread r0 = r0.upstreamReader     // Catch:{ all -> 0x0140 }
                if (r0 == 0) goto L_0x002e
                okio.Timeout r0 = r1.timeout     // Catch:{ all -> 0x0140 }
                okhttp3.internal.cache2.Relay r5 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0140 }
                r0.waitUntilNotified(r5)     // Catch:{ all -> 0x0140 }
                goto L_0x000b
            L_0x002e:
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0140 }
                java.lang.Thread r6 = java.lang.Thread.currentThread()     // Catch:{ all -> 0x0140 }
            ...
            L_0x0039:
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0140 }
                okio.Buffer r0 = r0.buffer     // Catch:{ all -> 0x0140 }
                long r11 = r0.size()     // Catch:{ all -> 0x0140 }
                r0 = 0
                long r11 = r7 - r11
                long r13 = r1.sourcePos     // Catch:{ all -> 0x0140 }
            ...
            L_0x0120:
                ...
                r0 = 0
                long r7 = r7 - r5
                long r2 = java.lang.Math.min(r2, r7)     // Catch:{ all -> 0x0140 }
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0140 }
                okio.Buffer r13 = r0.buffer     // Catch:{ all -> 0x0140 }
                long r5 = r1.sourcePos     // Catch:{ all -> 0x0140 }
                r0 = 0
                long r15 = r5 - r11
                r14 = r22
                r17 = r2
                r13.copyTo((okio.Buffer) r14, (long) r15, (long) r17)     // Catch:{ all -> 0x0140 }
                long r5 = r1.sourcePos     // Catch:{ all -> 0x0140 }
                r0 = 0
                long r5 = r5 + r2
