...
public final class RetryAndFollowUpInterceptor implements Interceptor {
    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        while (!this.canceled) {
            try {
                ...
                response = response != null ? proceed.newBuilder().priorResponse(response.newBuilder().body((ResponseBody) null).build()).build() : proceed;
    ...
    private Request followUpRequest(Response response) throws IOException {
        ...
        if (response != null) {
            ...
            switch (code) {
                case TapdaqError.NO_AD_AVAILABLE:
                case TapdaqError.FREQUENCY_CAP_MET:
                case 302:
                case 303:
                    break;
